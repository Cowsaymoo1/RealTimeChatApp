...
const NewGroupChatModal = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    try {
      ...
      console.error("An error occurred when creating group chat", error);
      ...
      <DialogContent className="sm:max-w-[425px] border-none">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            <Label htmlFor="groupNamme" className="text-sm font-semibold">
              Group Name
            </Label>
            <Input
              id="groupName"
          ...
          <DialogFooter>
            ...
            >
              {loading ? (
                ...
                <>
                  <UserPlus className="size-4 mr-2"> Create Group</UserPlus>
                </>
              )}
            </Button>
          </DialogFooter>
